    ...
    public function run(): void
    {
        $news = [
            [
                ...
                'author' => 'Admin Dumbaya Bulan',
                'views' => 1240,
                'title' => 'Peningkatan Infrastruktur Jalan Dumbaya Bulan: Mempercepat Akses Ekonomi Warga',
                'excerpt' => 'Pemerintah Dumbaya Bulan secara resmi memulai proyek pengaspalan jalan sepanjang 2,5 kilometer yang menghubungkan dusun tengah dengan area perkebunan warga.',
                ...
                'body' => [
                    'Pemerintah Dumbaya Bulan hari ini secara resmi memulai proyek pengaspalan jalan sepanjang 2,5 kilometer yang menghubungkan dusun tengah dengan area perkebunan warga. Proyek ini merupakan bagian dari program percepatan ekonomi desa yang didanai melalui Dana Desa tahun anggaran 2026.',
                    'Kepala Dumbaya Bulan menyatakan bahwa perbaikan akses jalan ini sangat krusial mengingat selama ini warga seringkali mengalami kendala saat mengangkut hasil bumi, terutama pada musim penghujan. "Dengan jalan yang lebih baik, biaya logistik petani akan berkurang dan harga jual produk kita bisa lebih kompetitif," ujarnya saat ditemui di lokasi proyek.',
                    'Infrastruktur adalah urat nadi ekonomi. Kami berkomitmen untuk memastikan setiap jengkal wilayah Dumbaya Bulan terkoneksi dengan layak demi kesejahteraan bersama.',
            ...
            [
                ...
                'author' => 'Admin Desa',
                'views' => 840,
                'title' => 'Pengembangan Kawasan Ekowisata Mangrove Desa Dumbaya Bulan',
                ...
                'body' => [
                    'Pemerintah Desa Dumbaya Bulan meluncurkan inisiatif pengembangan kawasan ekowisata hutan mangrove secara komprehensif. Upaya ini ditujukan untuk melestarikan bentang alam pesisir sekaligus memberdayakan perekonomian warga lokal.',
            ...
            [
                ...
                'body' => [
                    'Badan Permusyawaratan Desa (BPD) bersama jajaran Pemerintah Desa Dumbaya Bulan menyelenggarakan Rapat Pleno Terbuka untuk menyepakati prioritas program pembangunan yang tertuang dalam RKPDes 2024.',
            ...
            [
                ...
                'excerpt' => 'Kelompok tani Desa Dumbaya Bulan menerima bantuan traktor dan alat penggiling padi otomatis untuk meningkatkan efisiensi produksi.',
                ...
                'body' => [
                    'Dalam rangka modernisasi sektor agraris, kelompok tani Desa Dumbaya Bulan menerima paket bantuan alat dan mesin pertanian (Alsintan) modern dari dinas terkait.',
            ...
            [
                ...
                'excerpt' => 'Aksesibilitas antar wilayah di Desa Dumbaya Bulan terus ditingkatkan untuk memperlancar mobilitas warga dan distribusi hasil bumi.',
            ...
            [
                ...
                'views' => 1080,
                'title' => 'Festival Budaya Pesisir Desa Dumbaya Bulan Akan Segera Digelar',
                'excerpt' => 'Persiapan matang terus dilakukan untuk menyambut ribuan wisatawan dalam ajang tahunan pesta rakyat pesisir Desa Dumbaya Bulan.',
                ...
                'body' => [
                    'Masyarakat pesisir Desa Dumbaya Bulan bersiap memeriahkan perhelatan akbar tahunan Festival Budaya Pesisir yang akan berlangsung selama tiga hari penuh.',
                    ...
                    'Panitia pelaksana mengundang seluruh wisatawan untuk hadir menikmati keindahan budaya dan keramahan khas pesisir Dumbaya Bulan.'
                ]
            ]
        ];
