...
class LeaderGreetingSeeder extends Seeder
{
    public function run(): void
    {
        LeaderGreeting::create([
            ...
            'content' => 'Selamat datang di portal informasi digital Desa Dumbayabulan. Kami berkomitmen untuk mewujudkan tata kelola pemerintahan yang transparan dan akuntabel melalui pemanfaatan teknologi informasi bagi seluruh warga.'
        ]);
    }
}
